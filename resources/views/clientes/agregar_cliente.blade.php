      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre-txt" class="form-control" placeholder="Ingrese nombre del cliente">
              </div>
            <div class="mb-3">
                <label for="apellidos-txt" class="form-label">Apellidos</label>
                <input type="text" id="apellidos-txt" class="form-control" placeholder="Ingrese los apellidos del cliente">
            </div>
            <div class="mb-3">
